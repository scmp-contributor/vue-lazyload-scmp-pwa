...
var DEFAULT_LAZYLOAD_COMPONENT_OPTIONS = {
  observeBottom: true
};
  ...
  return function () {
    function Lazy(_ref) {
      var preLoad = _ref.preLoad,
          ...
          lazyComponentOptions = _ref.lazyComponentOptions;
  ...
  return {
    ...
    methods: {
      ...
      checkInView: function checkInView() {
        ...
        var observeBottom = this.lazyOptions.lazyComponentOptions.observeBottom ? this.rect.bottom > 0 : true;
        return inBrowser && this.rect.top < window.innerHeight * lazy.options.preLoad && observeBottom && this.rect.left < window.innerWidth * lazy.options.preLoad && this.rect.right > 0;
      },
      load: function load() {
        this.show = true;
        this.state.loaded = true;
